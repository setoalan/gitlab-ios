...
@interface LDMergeRequestStore ()

@property (nonatomic) NSArray *privateItems;

@end

@implementation LDMergeRequestStore

- (instancetype)init
{
    @throw [NSException exceptionWithName:@"Singleton" reason:@"Use + [LDMergeRequestStore sharedStore]" userInfo:nil];
    return nil;
}
...
{
    static LDMergeRequestStore *sharedStore = nil;
    if (!sharedStore) {
